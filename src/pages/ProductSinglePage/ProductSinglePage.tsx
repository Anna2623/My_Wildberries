              ...
              <div className='product-details font-manrope'>
                ...
                <div className='info flex align-center flex-wrap fs-14'>
                  <div className='rating'>
                    <span className='text-pink fw-5'>Рейтинг:</span>
                    <span className='mx-1'>
                      {product.rating}
                    </span>
                  </div>
                  ...
                  <div className='brand'>
                    <span className='text-pink fw-5'>Бренд:</span>
                    <span className='mx-1'>{product.brand}</span>
                  </div>
                  <div className='vert-line-pink'></div>
                  <div className='brand'>
                    <span className='text-pink fw-5'>Категория:</span>
                ...
                <div className='btns'>
                  ...
                  <button type="button" className='buy-now btn mx-3'>
                    <span className='btn-text'>купить сейчас</span>
                  </button>
                </div>
